...
BUS_ARR="9 9 9 9 10 10 10 10"						# i2c bus
# DES_ARR="0x2e 0x4e"									# DES_0 ~ DES_1
SER_ARR="0x31 0x32 0x33 0x34 0x41 0x42 0x43 0x44"	# SER_0 ~ SER_7
CAM_ARR="0x39 0x3a 0x3b 0x3c 0x49 0x4a 0x4b 0x4c"	# CAM_0 ~ CAM_7
DES_IDX="0 0 0 0 1 1 1 1"
